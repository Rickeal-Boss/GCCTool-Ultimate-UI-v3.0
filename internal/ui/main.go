...
func disableInputs(ui *model.UIComponents, disabled bool) {
	ui.UsernameEntry.Disable()
	ui.PasswordEntry.Disable()
	ui.NodeSelect.Disable()
	ui.AgentEntry.Disable()
	ui.HourEntry.Disable()
	ui.MinuteEntry.Disable()
	ui.AdvanceEntry.Disable()
	ui.ThreadEntry.Disable()
	ui.CourseTypeRadio.Disable()
	ui.CourseNameEntry.Disable()
	ui.TeacherEntry.Disable()
	ui.CourseNumEntry.Disable()
	ui.MinCreditEntry.Disable()
