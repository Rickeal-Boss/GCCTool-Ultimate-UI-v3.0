...
// buildLogTab 构建日志Tab（Material 风格）
func (a *App) buildLogTab() *fyne.Container {
	logCard := materialCard("运行日志", 6, a.ui.LogScroll)
...
// buildButtonBar 构建底部按钮栏（Material 风格）
func (a *App) buildButtonBar() fyne.CanvasObject {
	return mdButtonBar(a.ui.StartBtn, a.ui.StopBtn, a.ui.CopyLogBtn, "就绪")
}
